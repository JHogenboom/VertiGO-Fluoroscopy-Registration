"""
    ...
    Adaptation by Joshi Hogenboom - Maastro Clinic/Maastricht University Medical Centre- autumn 2021.
    Original to be found at https://github.com/fabio86d/HipHop_2D3Dregistration/blob/master/tests/Register_CT_pelvis.py
"""

from VertiGOCore import *
import os.path

ProjectDir = 'G:\Joost_(Joshi)\VertiGO'
